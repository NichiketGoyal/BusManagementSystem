 ...
 * @author Nichiket
 */
@WebServlet(name = "add_del_busTeach", urlPatterns = {"/add_del_busTeach"})
public class add_del_busTeach extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        SessionFactory  sf=cf.buildSessionFactory();
         ...
         if(bno!=null && !bno.isEmpty() && bs!=null && !bs.isEmpty() && bd!=null && !bd.isEmpty()   ){
             ...
             schedule sc=new schedule(bno,bs,bd);
         ...
         session.close();
         sf.close();
         RequestDispatcher rd= request.getRequestDispatcher("editBus_teach");
