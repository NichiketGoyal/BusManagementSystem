 ...
 * @author Nichiket
 */
@WebServlet(name = "editBus_teach", urlPatterns = {"/editBus_teach"})
public class editBus_teach extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       RequestDispatcher rd= request.getRequestDispatcher("editBus_teach.jsp");
