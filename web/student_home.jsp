<%-- 
    ...
    Created on : Mar 28, 2019, 10:19:42 AM
    Author     : Nichiket
--%>
  ...
  <body class="main">
    ...
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
      ...
      <nav class="my-2 my-md-0 mr-md-3">
        <a class="p-2" href="student_home.jsp" style="text-decoration: none; color: #000; font-family: impact;">Home</a>
        <a class="p-2" href="change_pass.html" style="text-decoration: none; color: #000; font-family: impact;">Change</a>
...
<h2 class="heading">Search Bus using route or by Bus Number</h2></center>
   ...
   <div class="container" style="padding-top: 5%;width: 35%;">
     ...
     <div class="card mb-4 box-shadow">
         <form action="Student_bus" method="get" ><center>
...
<div class="card-body" style="width: 40%;" >
    <form action="Student_bus" method="get">
